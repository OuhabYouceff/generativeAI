...
const loadDataFromLocalstorage = () => {
    ...
    const defaultText = `<div class="default-text">
                            <h1>VisioWave</h1>
                            <p>Start generating images with a simple prompt!</p>
                        </div>`;
...
const generateImage = async (prompt) => {
    ...
    try {
        ...
        await saveImageToDatabase(blob);
    } catch (error) {
...
const saveImageToDatabase = async (blob) => {
    const formData = new FormData();
...
const handleOutgoingChat = () => {
    ...
    clearExistingContent(); // Clear existing content before generating new image
